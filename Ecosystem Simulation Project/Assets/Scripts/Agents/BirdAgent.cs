...
public class BirdAgent : Agent
{
    ...
    public override void Initialize()
    {
        ...
        if (attributes == null) throw new System.Exception("Attributes not set for bird agent");

        birdActions = GetComponent<BirdActions>();
        if (birdActions == null) throw new System.Exception("BirdActions not set in BirdAgent");

        manager = FindObjectOfType<AIManager>();
        if (manager == null) throw new System.Exception("AIManager not set in BirdAgent parent");
    }
    ...
    public override void OnEpisodeBegin()
    {
        ...
        birdActions.EpisodeBegin();
    }
    public override void OnActionReceived(ActionBuffers actions)
    {
        birdActions.ActionsRecieved(actions);
    }
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        birdActions.Heuristic(actionsOut);
    }
}
